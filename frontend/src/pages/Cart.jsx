      ...
      <div>
        {
          cartData.map((item,index)=>{
            ...
            return(
              <div key={index} className='py-4 border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols[4fr_2fr_o.5fr] items-center gap-4'>
                <div className='flex items-start gap-6'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center mt-2 gap-5'>
                      ...
                      <p className='px-2 sm:px-3 sm:py-1 borderb bg-slate-50'>{item.size}</p>
                    </div>
                  </div>
                </div>
